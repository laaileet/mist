...
!define GROUPNAME "Ethereum Vega"
!define HELPURL "https://github.com/EthereumVega/mist/releases/issues"
!define UPDATEURL "https://github.com/EthereumVega/mist/releases"
...
!macro ENVFUNC un
  Function ${un}setenv
    ...
    StrCpy $NODEDATADIR "$APPDATA\Ethereum Vega"
